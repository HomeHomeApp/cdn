...
var callback='#call'+new Date().getTime();var s=document.createElement("script");s.src="https://cdn.jsdelivr.net/gh/HomeHomeApp/cdn@latest/version.php?callback=getVersion"+callback;console.log(s.src);document.body.appendChild(s);function accord()
...
function resetme()
{var r=confirm("All settings will be removed. Continue?");if(r==!0)
...
function local()
{var r=confirm("Restart required for local mode changes. Continue?");if(r==!0)
...
{var favlink=document.querySelector("link[rel*='icon']")||document.createElement('link');favlink.type='image/x-icon';favlink.rel='shortcut icon';favlink.href='https://cdn.jsdelivr.net/gh/HomeHomeApp/cdn@latest/favicon.ico';document.getElementsByTagName('head')[0].appendChild(favlink);var meta2=document.createElement('meta');meta2.name="viewport";meta2.content="width=device-width, initial-scale=1";document.getElementsByTagName('head')[0].appendChild(meta2)})();(function()
{var nocache='?v='+new Date().getTime();var link=document.querySelector("link[rel*='stylesheet']")||document.createElement('link');link.type='text/css';link.rel='stylesheet';link.href='https://cdn.jsdelivr.net/gh/HomeHomeApp/cdn@latest/style.css'+nocache;document.getElementsByTagName('head')[0].appendChild(link)})();function anime()
